    ...
    public class ValidationActor : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            if (string.IsNullOrEmpty(msg))
            {
                ...
                _consoleWriterActor.Tell(new Messages
                        .NullInputError("No input received."));
            }
            else
            {
                ...
                if (valid)
                {
                    ...
                    _consoleWriterActor.Tell(new Messages
                        .InputSuccess("Thank you! Message was valid."));
                }
                else
                {
                    // signal that input was bad
                    _consoleWriterActor.Tell(new Messages
                        .ValidationError("Invalid: input had odd number of characters."));
                }
            }

            // tell sender to continue doing its thing
            // (whatever that may be, this actor doesn't care)
            Sender.Tell(new Messages
                .ContinueProcessing());
